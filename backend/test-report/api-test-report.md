...
- 通过: 36
- 失败: 0
- 生成时间: 2026-05-31T18:56:52.098840700

| Method | Path | Status | Content-Type | OK | Latency(ms) | Handler |
|---|---|---:|---|---|---:|---|
|POST |/api/agent/chat |200 |application/json |PASS |5 |AgentController#chat |
|POST |/api/agent/chat/stream |200 | |PASS |1 |AgentController#chatStream |
|POST |/api/auth/login |200 |application/json |PASS |8 |AuthController#login |
...
|POST |/api/config |200 |application/json |PASS |3 |ConfigController#updateConfig |
...
|GET |/api/jobs/page |200 |application/json |PASS |10 |JobInfoController#pageQuery |
...
|GET |/api/jobs/stats/overview |200 |application/json |PASS |3 |JobInfoController#getOverview |
|GET |/api/jobs51/page |200 |application/json |PASS |1 |JobInfo51JobController#pageQuery |
|GET |/api/jobs51/stats/overview |200 |application/json |PASS |0 |JobInfo51JobController#getOverview |
|GET |/api/pipeline/artifacts |200 |application/json |PASS |5 |PipelineController#artifacts |
|POST |/api/pipeline/dashboard/run |200 |application/json |PASS |1 |PipelineController#runDashboard |
|GET |/api/pipeline/file |200 |application/json |PASS |7 |PipelineController#file |
...
|POST |/api/rag/reindex/jobs |200 |application/json |PASS |3 |RagAdminController#reindexJobs |
...
|POST |/api/user/favorites |200 |application/json |PASS |10 |UserController#addFavorite |
|GET |/api/user/job-history |200 |application/json |PASS |6 |UserController#listJobHistory |
|POST |/api/user/job-history |200 |application/json |PASS |5 |UserController#recordJobHistory |
|GET |/api/user/match-history |200 |application/json |PASS |5 |UserController#listMatchHistory |
|GET |/api/user/match-history/1 |200 |application/json |PASS |2 |UserController#getMatchHistoryDetail |
|GET |/api/user/profile |200 |application/json |PASS |2 |UserController#getProfile |
|PUT |/api/user/profile |200 |application/json |PASS |3 |UserController#upsertProfile |
